...
which.min(val.errors) #9 variables, it should be 13!
...
B
#It is obvious that some smaller coefficients were missed, their signal probably small compared to the noise.
#The overlapping coefficients show a very good fit however.
...
coef(subset,id=13) 
#The plot shows a very similar pattern to the one shown in the test MSE, with a dip in coefficient error when
#the 9 parameters are fit. For the correct number of parameters the overall error in the coefficients actually increases.
