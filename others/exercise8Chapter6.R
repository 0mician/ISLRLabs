...
subsetSummary$adjr2 # 3 predictors, which is correct!
...
plot(fwdSUM$bic)
subsetSummary$bic # 3 predictors, which is correct! 
plot(fwdSUM$cp)# 3 predictors, which is correct!
plot(fwdSUM$adjr2)# 3 predictors, which is correct!
coef(fwd,3)
...
plot(bwdSUM$adjr2)
coef(bwd,3)
#again all find the correct model! This will change if you increase the error amplitude.
